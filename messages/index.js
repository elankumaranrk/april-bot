...
bot.dialog('allocationchange', [function (session, args, next) {
    ...
    if (!results.response) {
        ...
        builder.Prompts.text(session, `**2-step Verification.** Please enter the verification code generated by your mobile app. [Problems with your code?](http://april-web.firebaseapp.com/email)`);
